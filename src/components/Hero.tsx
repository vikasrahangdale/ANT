  ...
  return (
    <div className="relative w-full h-64 md:h-80 lg:h-96 bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 flex items-center">
          
          {/* LEFT LOGO IMAGE */}
          <img
            src="/png-logo.png"
            alt="TVS Manufacturing Facility"
            className="w-50 h-40 absolute left-0  top-60 object-contain opacity-90 "
          />

          {/* TEXT */}
          <div className="max-w-3xl">
            <h1 className="text-4xl mb-20 md:text-6xl lg:text-5xl font-bold text-gray-900 leading-tight">
